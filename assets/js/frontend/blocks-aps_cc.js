...
/*!*****************************************!*\
  !*** ./resources/js/frontend/aps_cc.js ***!
  \*****************************************/
...
const defaultLabel = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Credit / Debit card', 'amazon-payment-services');
const settings = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_4__.getSetting)('aps_cc_data', {});
      ...
      const unsubscribe = onPaymentSetup(async () => {
        ...
        if (aps_cc_token_checked) {
          ...
          if (hosted_checkout_form) {
            ...
            if (validateCardResult.validity && validateHolderNameResult.validity && validateCardCVVResult.validity && validateExpiryResult.validity) {
...
/******/ })()
;
//# sourceMappingURL=blocks-aps_cc.js.map