...
class APS {
	...
	public function load_wc_hooks() {
        ...
        $this->loader->add_action( 'woocommerce_scheduled_subscription_payment_' . APS_Constants::APS_PAYMENT_TYPE_TAMARA, $aps_wc_hooks, 'aps_tamara_subscription_payment', 10, 2 );
