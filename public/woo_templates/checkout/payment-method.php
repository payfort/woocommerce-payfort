...
if ( APS_Constants::APS_PAYMENT_TYPE_APPLE_PAY === $gateway->id ) {
	...
	<li class="wc_payment_method payment_method_<?php echo esc_attr( $gateway->id ); ?>">
		...
		<label for="payment_method_<?php echo esc_attr( $gateway->id ); ?>">
			<?php echo APS_Constants::APS_PAYMENT_TYPE_CC == $gateway->id ? $gateway->get_filter_title() : $gateway->get_title(); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?> <?php echo $gateway->get_icon(); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?>
		</label>
		<?php if ( $gateway->has_fields() || $gateway->get_description() ) : ?>
