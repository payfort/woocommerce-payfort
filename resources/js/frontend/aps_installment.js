...
const settings = getSetting( 'aps_installment_data', {} );
        ...
        useEffect(() => {
            const unsubscribe = onPaymentSetup(async () => {
                ...
                if (aps_cc_token_checked) {
                    ...
                    if (!aps_cvv_checked || !aps_cvv_checked.value) {
                        return {
                            ...
                            message: __('Please enter your CVV!', 'amazon-payment-services'),
                        };
                    }
                }
                ...
                if (!installment_plan_code || !installment_plan_code.value) {
                    return {
                        type: emitResponse.responseTypes.ERROR,
                        message: __('Please select an installment plan!', 'amazon-payment-services'),
                    };
                }
                ...
                if (!installment_term || !installment_term.checked) {
                    return {
                        type: emitResponse.responseTypes.ERROR,
                        message: __('Please accept the terms and conditions!', 'amazon-payment-services'),
                    };
                }
